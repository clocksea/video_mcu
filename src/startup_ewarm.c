...
// 
// This is part of revision 7243 of the EK-LM3S9B90 Firmware Package.
//
//*****************************************************************************
...
extern void GPIOEIntHandler(void);	//add by mengch
...
//
//*****************************************************************************
static unsigned long pulStack[512] @ ".noinit";  //64
...
__root const uVectorEntry __vector_table[] @ ".intvec" =
{
    ...
    GPIOEIntHandler,                  		// GPIO Port E	//new add by mengch
